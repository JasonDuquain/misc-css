...
/*  The following 3 fns are responsible for creating (and returning) timelines for each     section of the entire banner. 
...
function getIntroTextTimeline() {
  ...
  .from($stunning, 0.2, {top:-60}, "+=0.1") 
  .from($animations, 0.4, {top:400, ease:Power2.easeIn})
  .to($slide1, 0.3, {rotation:-90, left:-125, top:26}, "rotateOut") 
  .to($stunning, 0.2, {left:-300}, "rotateOut") 
  .to($animations, 0.2, {left:30}, "+=0.2")
  .to($animations, 0.2, {left:122}, "for") 
...
function getDevicesTimeline() {
  ...
  .add("desktopOut", "+=0.5")
  .to($deviceHead, 0.25, {rotationX:-90, transformOrigin:"50% 100%"}, "desktopOut")
