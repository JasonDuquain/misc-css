...
widthHeight.querySelector(".btn--wh").addEventListener("click", () => {
	const container1 = widthHeight.querySelector(".container1"),
        container2 = widthHeight.querySelector(".container2"),
        box = widthHeight.querySelector(".box"),
